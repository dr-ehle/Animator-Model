 ...
 * gradually, unless of course the number of ticks T is equal to zero. During this gradual transition
 * of state, other elements must be allowed to transition to other states as well.
 *
